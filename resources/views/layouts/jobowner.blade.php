...
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <div class="sidebar-brand">
        ...
        <div>
            ...
            <div class="sidebar-brand-role">Job Owner Panel</div>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('dashboard.jobowner') }}"
           class="nav-item {{ request()->routeIs('dashboard.jobowner') ? 'active' : '' }}">
            <i class="bi bi-grid-1x2-fill"></i> Dashboard
        </a>

        <div class="nav-section-label">My Jobs</div>
        ...
        <a href="{{ route('jobowner.profile') }}"
           class="nav-item {{ request()->routeIs('jobowner.profile') ? 'active' : '' }}">
    ...
    <div class="sidebar-bottom">
        <a href="{{ route('jobowner.profile') }}" class="sidebar-user-card">
            ...
            <div style="flex:1;min-width:0;">
                ...
                <div class="sidebar-user-type">Job Owner</div>
            </div>
            <i class="bi bi-chevron-right"
               style="color:rgba(255,255,255,.25);font-size:.7rem;"></i>
        </a>
    </div>
...
<header class="admin-topbar">
    ...
    <div class="topbar-actions">
                ...
                <div class="notif-list" id="notifList">
                    <div class="notif-empty">
                        <i class="bi bi-arrow-clockwise"
                           style="font-size:1.4rem;display:block;margin-bottom:.5rem;
        ...
        {{-- Profile --}}
        <a href="{{ route('jobowner.profile') }}" class="profile-btn">
            @if(Auth::user()->profile_picture)
                <img src="{{ asset('storage/' . Auth::user()->profile_picture) }}"
    ...
    if (!Array.isArray(items) || !items.length) {
        ...
        list.innerHTML = `<div class="notif-empty">
            <i class="bi bi-bell-slash"
               style="font-size:1.8rem;display:block;margin-bottom:.5rem;opacity:.4;"></i>
            All caught up!
        </div>`;
        return;
    }
