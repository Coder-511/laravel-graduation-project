    ...
    <div class="col-lg-8 fade-in-up delay-1">
        <div class="page-card">
            ...
            <div class="page-card-body">
                ...
                {{-- Avatar preview --}}
                <div style="display:flex;align-items:center;gap:1.25rem;margin-bottom:1.75rem;padding-bottom:1.5rem;border-bottom:1px solid var(--border-light);">
                    <div id="avatarPreviewWrap">
                        ...
                        @else
                            <div id="avatarFallback"
                                 style="width:80px;height:80px;border-radius:50%;background:linear-gradient(135deg,var(--primary),var(--navy-light));display:flex;align-items:center;justify-content:center;color:#fff;font-size:2rem;font-weight:700;border:3px solid var(--border-light);">
                                {{ strtoupper(substr($user->name, 0, 1)) }}
                            </div>
                        @endif
                    </div>
                    <div>
                        <div style="font-size:1.05rem;font-weight:700;color:var(--dark);">{{ $user->name }}</div>
                        <div style="font-size:.82rem;color:var(--text-muted);">{{ $user->email }}</div>
                        <span class="badge-pill badge-admin" style="margin-top:.4rem;">Administrator</span>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('profile.update', $user->id) }}"
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Divider --}}
                        <div class="col-12">
                            <div style="border-top:1px solid var(--border-light);padding-top:1.25rem;margin-top:.25rem;">
                                <div style="font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--text-muted);margin-bottom:1rem;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group-admin">
                                ...
                                <div style="position:relative;">
                                    ...
                                    <button type="button" onclick="togglePw('pwField','pwEye')"
                        ...
                        <div class="col-md-6">
                            <div class="form-group-admin">
                                ...
                                <div style="position:relative;">
                                    <input type="password" name="password_confirmation" id="pwConfField"
                                           class="form-control-admin"
                                           placeholder="Repeat new password">
                                    <button type="button" onclick="togglePw('pwConfField','pwConfEye')"
                                            style="position:absolute;right:10px;top:50%;transform:translateY(-50%);background:none;border:none;color:var(--text-muted);cursor:pointer;">
                    ...
                    <div style="margin-top:1.5rem;display:flex;gap:.75rem;justify-content:flex-end;">
                        <a href="{{ route('dashboard.admin') }}" class="btn-ghost">Cancel</a>
