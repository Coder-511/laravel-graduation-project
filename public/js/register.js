document.addEventListener('DOMContentLoaded', function () {
    ...
    // ── Read language live (called every time, not once at load) ─
    function isArabic() {
    ...
    // ── Refresh strength label (called after language switch too) ─
    ...
    // auth.js calls applyAuthLanguage() which changes dir/lang on <html>.
    // We watch for that attribute change and refresh both indicators.
    ...
    observer.observe(document.documentElement, {
        attributes: true,
        attributeFilter: ['lang'],   // only fires when lang attr changes
    });
